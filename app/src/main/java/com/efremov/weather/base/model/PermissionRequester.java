...
public class PermissionRequester {
    ...
    private PermissionRequester() {
        LocalBroadcastManager.getInstance(App.app()).registerReceiver(new BroadcastReceiver() {
            @Override
    ...
    public void requestPermission(@NonNull OnResultListener listener, @NonNull String permission) {
        ...
        LocalBroadcastManager.getInstance(App.app().getApplicationContext()).sendBroadcast(requestPermissionIntent);
    }
